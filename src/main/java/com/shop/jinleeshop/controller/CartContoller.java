...
public class CartContoller {
    ...
    // 장바구니의 수량을 업데이트하는 요청을 처리할 수 있도록 하는 로직
    // HTTP 메서드에서 PATCH는 요청된 자원의 일부를 업데이트할 때 사용(여기서는 장바구니 상품의 수량만 업데이트)
    ...
    // HTTP 메서드에서 DELETE의 경우 요청된 자원을 삭제할 때 사용(여기서는 장바구니 상품을 삭제)
